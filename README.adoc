...
:kube-prometheus-stack-chart-version: 58.0.1
...
|*{kube-prometheus-stack-chart-version}* |{chart-url}[Chart] |https://artifacthub.io/packages/helm/prometheus-community/kube-prometheus-stack/{kube-prometheus-stack-chart-version}?modal=values[`values.yaml`]
|===
