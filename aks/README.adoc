...
==== [[input_cluster_resource_group_name]] <<input_cluster_resource_group_name,cluster_resource_group_name>>
...
|[[input_cluster_resource_group_name]] <<input_cluster_resource_group_name,cluster_resource_group_name>>
|The Resource Group for the kube-prometheus-stack managed identity creation.
|`string`
|n/a
|yes
